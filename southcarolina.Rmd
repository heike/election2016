---
title: "Presidential Candidates in South Carolina"
...
caucus <- data.frame(State=c("IA"), Date=ymd(c("2016/02/01")))

caucuslayer <- function(ymax) {
  list(
  annotate("segment", x=caucus$Date, xend=caucus$Date, y = 2, yend=ymax,
               colour="grey75"),
  annotate("text", x=caucus$Date, y = 0, label=caucus$State,
               colour="grey75", size=4)
)
}
###############
#  functions
...
###############
# show! 
rcp.gop <- "http://www.realclearpolitics.com/epolls/2016/president/sc/south_carolina_republican_presidential_primary-4151.html"
...
rcp.dem <- "http://www.realclearpolitics.com/epolls/2016/president/sc/south_carolina_democratic_presidential_primary-4167.html"
