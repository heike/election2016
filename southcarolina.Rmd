...
polls[1,]$endDate <- as.Date("2016/02/20")
...
mpolls <- melt(polls, measure.vars=5:10, na.rm=TRUE)
...
```{r, echo=FALSE, fig.width=7.5, fig.height=5, warning=FALSE}
...
polls <- data.frame(polls, d2)
polls[1,]$endDate <- as.Date("2016/02/27")
