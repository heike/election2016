---
title: "Presidential Candidates in Virginia"
author: "Heike Hofmann"
output: html_document
---

```{r, echo=FALSE, fig.width=10, fig.height=7.5, message=FALSE, warning = FALSE}
library(XML)
library(lubridate)
library(dplyr)
library(stringr)
...
###############
# show! 
rcp.gop <- "http://www.realclearpolitics.com/epolls/2016/president/va/virginia_republican_presidential_primary-3921.html"

tables <- readHTMLTable(rcp.gop)
polls <- data.frame(tables[[1]])
...
mpolls <- melt(polls, measure.vars=5:9, na.rm=TRUE)
...
rcp.dem <- "http://www.realclearpolitics.com/epolls/2016/president/va/virginia_democratic_presidential_primary-3922.html"

tables <- readHTMLTable(rcp.dem)
polls <- data.frame(tables[[2]])
