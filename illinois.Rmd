---
title: "Presidential Candidates in Illinois"
...
source("caucus.R")
caucus <- subset(caucus, month(Date) > 2)
###############
#  functions
source("functions.R")
###############
# show! 
rcp.gop <- "http://www.realclearpolitics.com/epolls/2016/president/il/illinois_republican_presidential_primary-4251.html"
...
mpolls <- melt(polls, measure.vars=5:8, na.rm=TRUE)
...
#    mpolls$voterType <- factor(mpolls$voterType, c("RV", "LV", "A"))
    ...
    p <- ggplot(aes(x=endDate, y=value, colour=Poll), data=subset(mpolls, (year >= 2016) & (month >= 2))) +
...
rcp.dem <- "http://www.realclearpolitics.com/epolls/2016/president/il/illinois_democratic_presidential_primary-5567.html"
